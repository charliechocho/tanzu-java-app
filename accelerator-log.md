...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=charliechocho&repo=tanzu-java-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=charliechocho&repo=tanzu-java-app'
